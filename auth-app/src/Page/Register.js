...
export const Register = () => {
  ...
  return (
    ...
    <div className="form grid justify-items-center ml-[10%]">
      ...
      className='border-2 mt-1 border-green-300 rounded-lg pb-2 px-3 w-[250px] outline-green-700 lg:w-[400px] py-3'/><br/>
    <input type="email" name="email" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder='Enter your email' 
    className='border-2 mt-1 border-green-300 rounded-lg pb-3 px-3 w-[250px] outline-green-700 lg:w-[400px] py-3'/><br/>
    <input
            type="file"
            name="image"
            onChange={(e) => setImage(e.target.files[0])}
            className="border-2 border-green-300 rounded-lg px-3 w-[250px] outline-green-700 lg:w-[400px] mt-1 py-3 mb-3"
          /> 
           <br/>
    
    <input type="hidden" name='role' value={role} />
  
          <input type="number" name="phone" value={phone} onChange={(e)=>setPhone(e.target.value)} placeholder='Enter your phone'
           className='border-2 mt-1 border-green-300 rounded-lg px-3 w-[250px] outline-green-700 lg:w-[400px] py-3'/><br/>
   
    <input type="password" name="password" value={password} onChange={(e)=>setPassword(e.target.value)} placeholder='Enter your password' 
    className='border-2 mt-1 border-green-300 rounded-lg px-3 w-[250px] outline-green-700 lg:w-[400px] py-3'/>
